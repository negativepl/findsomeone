...
Content Bot is an AI-powered system for automatic generation of sample listings using GPT-5 Nano. The system fills categories with content that:
...
- Titles and descriptions generated by GPT-5 Nano
...
SELECT
  ...
  content_bot_model,               -- Model (default: gpt-5-nano)
...
- **`20250119000001_add_ai_generated_posts.sql`** - Adds `is_ai_generated`, creates bot account
- **`20250119000002_add_content_bot_settings.sql`** - Adds bot settings to `ai_settings`
...
- **OpenAI GPT-5 Nano**: Theoretically unlimited, but 500ms delay added
...
**Solution**: Run migration `20250119000002_add_content_bot_settings.sql`

### Problem: "No content generated" or GPT errors
**Solution**:
- Check `OPENAI_API_KEY` in `.env.local`
- Make sure you have access to GPT-5 Nano
