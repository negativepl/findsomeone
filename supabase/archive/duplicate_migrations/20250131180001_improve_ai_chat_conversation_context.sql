-- Improve AI chat to better understand conversation context
UPDATE ai_settings
...
4. Użytkownik (kolejna wiadomość po otrzymaniu wyników): "pilnie potrzebuję, może być nawet droższa"
   Odpowiedź:
   SEARCH_INTENT: tak
   QUERY: sprzątanie mieszkania
   CITY:
   ...
   PRICE_MAX:
   SORT:
   RESPONSE: Oto wszystkie osoby oferujące sprzątanie mieszkań:

5. Użytkownik: "Szukam najlepszego elektryka w Warszawie"
   Odpowiedź:
   SEARCH_INTENT: tak
   QUERY: elektryk
   CITY: Warszawa
...
7. Użytkownik (po pytaniu): "wszędzie"
   Odpowiedź:
   SEARCH_INTENT: tak
   QUERY: malarz
   CITY:
...
8. Użytkownik: "Jak dodać ogłoszenie?"
...
- Jeśli użytkownik pisze kolejną wiadomość o tej samej usłudze którą już wyszukałeś - użyj tego samego miasta (lub jego braku) co poprzednio';
