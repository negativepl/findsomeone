-- SIMPLE AUTOCOMPLETE - SHOWS REAL TITLES AND CATEGORIES
-- No fancy extraction - just show what actually exists in posts
...
begin
  ...
  return query
  with
  -- 1. CATEGORIES that match (HIGHEST PRIORITY)
  ...
  -- 2. FULL POST TITLES that match (show actual titles)
