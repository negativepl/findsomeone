...
-- Reference data including cities and categories
-- =====================================================
-- This file contains all the reference/seed data for
-- the platform including Polish cities and the complete
-- category hierarchy.
-- =====================================================
...
-- CITIES DATA
-- =====================================================
-- Insert Polish cities data (49 cities, 20 popular)
...
-- CATEGORIES DATA
-- =====================================================
-- Main categories with Lucide icons
...
-- SET DISPLAY ORDER
-- =====================================================
-- Set display_order alphabetically, with "Inne" and "Pozostałe" at the end
