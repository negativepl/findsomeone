-- Add new comprehensive categories for local classifieds platform
-- Similar to OLX but more local-focused
-- Main categories have icons, subcategories don't need icons
-- PREREQUISITE: All old categories must be manually deleted first!
...
BEGIN
  ...
  INSERT INTO categories (name, slug, description, parent_id) VALUES
    ...
    ('Sprzątanie usługi', 'sprzatanie-uslugi', 'Sprzątanie domów, biur', uslugi_id),
    ...
    ('Opieka nad zwierzętami usługi', 'opieka-nad-zwierzetami-uslugi', 'Hotel dla zwierząt, wyprowadzanie', uslugi_id),
    ('Opieka nad dziećmi usługi', 'opieka-nad-dziecmi-uslugi', 'Niania, opieka', uslugi_id),
  ...
  INSERT INTO categories (name, slug, description, parent_id) VALUES
    ...
    ('Akcesoria moda', 'akcesoria-moda', 'Paski, szaliki, czapki', moda_id),
  ...
  INSERT INTO categories (name, slug, description, parent_id) VALUES
    ...
    ('Gry planszowe hobby', 'gry-planszowe-hobby', 'Gry planszowe dla dorosłych', sport_hobby_id),
