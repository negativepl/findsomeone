-- =====================================================
-- ADD BOOKING NOTIFICATIONS SUPPORT
-- =====================================================
-- Adds booking_request to activity_type enum and updates notification trigger

-- Update activity_logs activity_type to include booking_request
...
ALTER TABLE activity_logs ADD CONSTRAINT activity_logs_activity_type_check
  CHECK (activity_type IN ('post_created', 'post_viewed', 'message_received', 'message_sent', 'favorite_added', 'review_received', 'booking_request'));

-- Update push notification trigger to handle booking requests
