          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-3 shrink-0">
            {user ? (
              <>
                {showAddButton && (
                  <Link href="/dashboard/my-posts/new">
                    <Button className="bg-brand hover:bg-brand/90 text-brand-foreground font-semibold rounded-full h-10 px-3 lg:px-6 transition-all border-0 gap-2">
              ...
              <>
                ...
                <Link href="/signup">
                  <Button className="bg-brand hover:bg-brand/90 text-brand-foreground font-semibold rounded-full h-10 px-4 lg:px-6 transition-all border-0">
                    Zarejestruj
                  </Button>
                </Link>
              </>
