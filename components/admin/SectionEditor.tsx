    ...
    return (
      <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-black mb-4">Podstawowe ustawienia</h3>
          ...
          {metadata && metadata.configSchema.length > 0 && (
            <div className="space-y-6 pt-6 border-t-2 border-black/10">
              <h3 className="text-lg font-bold text-black mb-6">Konfiguracja sekcji</h3>
          ...
          <div className="space-y-6 pt-6 border-t-2 border-black/10">
            <h3 className="text-lg font-bold text-black mb-6">Stylowanie i widoczność</h3>
