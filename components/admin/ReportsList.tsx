            ...
            <div className="px-6 py-4 border-t border-border bg-muted/50 space-y-2">
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  disabled={isProcessing}
                  className="px-4 py-2.5 rounded-full bg-card border border-border hover:bg-muted text-foreground font-medium transition-colors disabled:opacity-50 text-sm"
                >
                  Odrzuć
                </button>
                <button
