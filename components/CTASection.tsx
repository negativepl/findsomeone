      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-32 h-32 md:w-48 md:h-48 flex-shrink-0 md:rotate-12">
            <LottieIcon
              animationPath="/animations/marketing-campaign-orange.json"
              fallbackSvg={
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 430 430">
                  <g strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <path stroke="#c44e35" strokeMiterlimit="10" strokeWidth="12" d="M300 195c33.137 0 60-26.863 60-60s-26.863-60-60-60-60 26.863-60 60 26.863 60 60 60"/>
                    <path stroke="#c44e35" strokeMiterlimit="10" strokeWidth="12" d="m286 109 40 25.065L286 159z"/>
                    <path stroke="#c44e35" strokeMiterlimit="10" strokeWidth="12" d="M169.88 155H90.12C81.804 155 75 148.196 75 139.88V60.12C75 51.804 81.804 45 90.12 45h79.76c8.316 0 15.12 6.804 15.12 15.12v79.76c0 8.316-6.804 15.12-15.12 15.12"/>
                    ...
                    <path stroke="#c44e35" strokeMiterlimit="10" strokeWidth="12" d="M364.88 360h-79.76c-8.316 0-15.12-6.804-15.12-15.12v-79.76c0-8.316 6.804-15.12 15.12-15.12h79.76c8.316 0 15.12 6.804 15.12 15.12v79.76c0 8.316-6.804 15.12-15.12 15.12"/>
