      ...
      <div className="container mx-auto px-6 pt-8 md:pt-12">
        <div className="grid md:grid-cols-4 gap-4 md:gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            {/* Zespół */}
            <div className="mt-6">
              <div className="text-sm font-semibold text-foreground mb-3">Zespół</div>
              <div className="space-y-2 text-sm text-muted-foreground">
                <a href="mailto:mbaszewski@findsomeone.app" className="flex items-center gap-2 hover:text-foreground transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
