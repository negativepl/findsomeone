      ...
      <div className="container mx-auto px-6 pt-6 md:pt-12 pb-6">
        <div className="grid md:grid-cols-4 gap-4 md:gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            {/* Kontakt */}
            <div className="mt-6">
              <h5 className="text-sm font-semibold text-black mb-3">Kontakt</h5>
            ...
            {/* Social Media */}
            <div className="mt-6">
              <h5 className="text-sm font-semibold text-black mb-3">Znajdź nas</h5>
            ...
            <div className="mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#24292e] hover:bg-[#2f363d] text-white px-4 py-2 rounded-full text-sm font-medium transition-all hover:shadow-lg group"
