...
interface ReportPostDialogProps {
  postId: string
  onReport: (postId: string, reason: string, description: string) => Promise<void>
}
...
const REPORT_REASONS = [
  ...
  { value: 'misleading', label: 'Wprowadzające w błąd' },
  { value: 'duplicate', label: 'Duplikat' },
  { value: 'other', label: 'Inne' },
]

export function ReportPostDialog({ postId, onReport }: ReportPostDialogProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-black/10 hover:bg-red-50 hover:border-red-200 text-black/60 hover:text-red-600 transition-colors text-[10px] sm:text-sm font-medium"
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-black">Zgłoś ogłoszenie</h2>
              </div>
              <button
            ...
            {success ? (
              <div className="text-center py-8">
                ...
                <p className="text-black/60">Dziękujemy. Sprawdzimy to ogłoszenie.</p>
              </div>
            ) : (
