    ...
    <section className="container mx-auto px-6 py-6 md:py-14">
      ...
      <div className="hidden md:block bg-card border border-border rounded-3xl p-8 group/section overflow-visible">
        <div className="flex items-center justify-between mb-12">
          ...
          <Link href={`/posts?city=${encodeURIComponent(city)}`} className="rounded-full border border-border hover:bg-muted text-foreground px-6 py-2.5 text-sm font-medium transition-colors inline-block bg-card">
            Zobacz wszystkie
          </Link>
        </div>
