...
export default async function Home() {
  ...
  // Fetch newest posts (mixed seeking and offering)
  ...
  // Fetch popular categories (by post count)
  const { data: popularCategories } = await supabase
    .rpc('get_popular_categories', { limit_count: 8 })
  ...
  return (
    <>
      ...
      {popularCategories && popularCategories.length > 0 && (
        <section className="container mx-auto px-6 py-12 md:py-14">
          <div className="mb-8 md:mb-12 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-black mb-2">Popularne kategorie</h3>
            <p className="text-lg text-black/60">Najczęściej wybierane przez użytkowników</p>
          </div>
              ...
              >
                <Card className="border-0 rounded-3xl bg-white hover:bg-[#F5F1E8] transition-all cursor-pointer h-full">
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="text-lg font-bold text-black mb-1">{category.name}</h4>
                    <p className="text-sm text-black/60">
                      {category.post_count} {category.post_count === 1 ? 'ogłoszenie' : 'ogłoszenia'}
                    </p>
                  </CardContent>
                </Card>
              </Link>
      ...
      {newestPosts && newestPosts.length > 0 && (
        <section className="container mx-auto px-6 py-12 md:py-14">
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm group/section">
            <div className="flex items-center justify-between mb-8 md:mb-12">
              <div>
                <h3 className="text-3xl md:text-4xl font-bold text-black mb-2">Nowe ogłoszenia</h3>
            ...
            <div className="relative">
              <div className="hidden md:block">
                <ScrollArrows containerId="newest-posts-scroll" />
              </div>
              <div id="newest-posts-scroll" className="overflow-x-auto scrollbar-hide -mx-6 md:-mx-8 snap-x snap-mandatory">
                <div className="horizontal-scroll-padding-mobile flex gap-4 pb-2">
      ...
      {/* City Based Posts Section - Client Component */}
