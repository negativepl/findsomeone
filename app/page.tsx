        ...
        {!user && (
          <section className="container mx-auto px-6 py-3 md:py-14">
            <div className="grid md:grid-cols-3 gap-6">
              <FeatureCard
                animationPath="/animations/coins-orange.json"
                fallbackSvg={
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 430 430">
                    ...
                    <g stroke="#c44e35" strokeLinejoin="round" strokeWidth="12" mask="url(#ExaLEMaqGFa)">
                    ...
                    <path stroke="#c44e35" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="12" d="M274.5 368.4c65.943 0 119.4-53.457 119.4-119.4s-53.457-119.4-119.4-119.4S155.1 183.057 155.1 249s53.457 119.4 119.4 119.4"/>
              ...
              <FeatureCard
                animationPath="/animations/consultation-orange.json"
                fallbackSvg={
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 430 430">
                    <path stroke="#c44e35" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="12" d="M130 290c16.569 0 30-13.431 30-30s-13.431-30-30-30-30 13.431-30 30 13.431 30 30 30"/>
                    <path stroke="#c44e35" strokeLinejoin="round" strokeWidth="12" d="M65 360c0-24.853 20.147-45 45-45h40c24.853 0 45 20.147 45 45v15H65z"/>
                    <path stroke="#c44e35" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="12" d="M300 290c16.569 0 30-13.431 30-30s-13.431-30-30-30-30 13.431-30 30 13.431 30 30 30"/>
                    <path stroke="#c44e35" strokeLinejoin="round" strokeWidth="12" d="M235 360c0-24.853 20.147-45 45-45h40c24.853 0 45 20.147 45 45v15H235z"/>
              ...
              <FeatureCard
                animationPath="/animations/security-orange.json"
                fallbackSvg={
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 430 430">
                    <g strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="12">
                      ...
                      <path stroke="#c44e35" d="m215 30-12.835 9.167A85 85 0 0 1 152.76 55H100l-35 55 11.661 11.662A53 53 0 0 1 89.35 176.24l-25.375 74.432c-19.853 58.235 20.044 119.693 81.318 125.264l9.496.863A97.65 97.65 0 0 1 215 405m0-375 12.834 9.167A85 85 0 0 0 277.24 55H330l35 55-11.662 11.662a53 53 0 0 0-12.688 54.578l25.374 74.432c19.854 58.235-20.043 119.693-81.317 125.264l-9.497.863A97.65 97.65 0 0 0 215 405m-55-120h110m-90 35h70"/>
                    </g>
                  </svg>
                }
