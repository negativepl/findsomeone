    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-20 md:pt-24 pb-8">
        ...
        <div className="mb-8 hidden md:block">
          <h1 className="text-4xl font-bold text-foreground mb-3">Regulamin</h1>
        ...
        <div className="bg-card border border-border rounded-2xl md:rounded-3xl p-5 md:p-8 mb-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">3. Warunki korzystania z Platformy</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">4. Rejestracja i konto użytkownika</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">5. Zasady publikowania ogłoszeń</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">6. Zasady komunikacji między użytkownikami</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">7. Płatności i rozliczenia</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">9. Naruszenia i sankcje</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">10. System zgłoszeń i moderacja</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
