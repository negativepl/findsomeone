          ...
          <DialogContent className="p-0 gap-0 overflow-hidden">
            ...
            <DialogFooter className="gap-3 p-4 md:p-6">
              <Button
                ...
                variant="outline"
                className="rounded-full border border-border bg-muted hover:bg-accent text-foreground"
              >
                Zacznij od początku
              </Button>
              <Button
              ...
              <div className="flex flex-row gap-3 justify-end">
                <Link href="/dashboard">
                  <Button
                    type="button"
                    variant="outline"
                    className="rounded-full border border-border bg-muted hover:bg-accent text-foreground h-11 px-6 text-sm"
                  >
                    Anuluj
                  </Button>
                </Link>
