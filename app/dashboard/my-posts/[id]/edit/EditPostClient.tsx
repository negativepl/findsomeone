            ...
            <div className="mt-8 pt-6 border-t-2 border-border rounded-b-3xl">
              <div className="flex flex-col md:flex-row gap-3 md:justify-end">
                ...
                <Button
                  ...
                  className="w-full md:w-auto rounded-full bg-brand hover:bg-brand/90 text-brand-foreground border-0 h-11 px-8 text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-yellow-800 dark:text-yellow-300">
                      Po zapisaniu zmian ogłoszenie zostanie ponownie zweryfikowane przez system moderacji.
                    </p>
                  </div>
                </div>
              </div>
