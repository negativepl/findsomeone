...
export function ChatWindow({ messages: initialMessages, currentUserId, otherUser }: ChatWindowProps) {
  ...
  return (
    <main className="flex-1 flex flex-col">
      {/* Messages Container */}
      <div className="flex-1 overflow-y-auto pb-36 md:pb-20">
        {/* Spacer for navbar - mobile needs h-16 (navbar height), desktop needs h-32 (navbar + chat header) */}
        <div className="h-20 md:h-32"></div>
        <div className="container mx-auto px-4 md:px-6 py-6 md:pb-2">
          {messages.length > 0 ? (
      ...
      <div className="fixed left-0 right-0 bg-card border-t border-border z-20 bottom-0 pb-[76px] md:pb-0 rounded-t-3xl">
