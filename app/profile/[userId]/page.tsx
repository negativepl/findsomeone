            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
              ...
              <div className="flex-1 w-full md:w-auto text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-3 mb-3">
                  <h1 className="text-2xl md:text-3xl font-bold text-foreground leading-none">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    {profile.rating > 0 ? (
                      ...
                      <span className="text-sm md:text-base text-muted-foreground italic">Brak opinii</span>
                    )}
                  </div>
